...
import 'package:sam_rider_app/driver_src/ui/widgets/full_photo.dart';
import 'package:sam_rider_app/driver_src/ui/widgets/loading.dart';
import 'package:sam_rider_app/driver_src/util/utils.dart';
import 'package:shared_preferences/shared_preferences.dart';

class Driver_Chat extends StatelessWidget {
  final String peerId;
  final String peerAvatar;

  Driver_Chat({Key key, @required this.peerId, @required this.peerAvatar})
      : super(key: key);
        ...
        children: <Widget>[
          data['type'] == 0
              ...
              : data['type'] == 1
                  ...
                  : Container(
                      child: Image.asset(
                        'assets/images/${data['content']}.gif',
                        width: 100.0,
                        height: 100.0,
                        fit: BoxFit.cover,
                      ),
