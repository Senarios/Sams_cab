...
class Driver_VerificationPage extends StatefulWidget {
  Driver_VerificationPage({Key key}) : super(key: key);

  _VerificationPageState createState() => _VerificationPageState();
}

class _VerificationPageState extends State<Driver_VerificationPage> {
  ...
  void onCompleted() {
    Navigator.pushNamed(context, '/driver_info');
  }
