...
class DataBloc {
  ...
  void makeOrder(dynamic data,List<File> images, Function onSuccess, Function(String) onError) {
    _fireData.makeOrder(data,images, onSuccess, onError);
  }
  ...
  void completeRide(String id,Function onSuccess)
  {
    _fireData.completeRide(id, onSuccess);
  }
