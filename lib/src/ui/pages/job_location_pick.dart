...
import 'package:sam_rider_app/src/ui/widgets/car_size.dart';
...
import 'package:sam_rider_app/src/ui/widgets/select_weight.dart';
            ...
            children: [
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          Padding(
                            ...
                            child: RidePicker(
                                _center, onPlaceSelected, Globals.stops),
                          )
                        ],
                      ),
                    ),
              ...
              Container(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: nextList ? (BuildContext context, int index) =>
                      SelectWeight(index, setWeight) : (BuildContext context,
                      int index) =>
                      CarSize(index, setCarSize),
                  shrinkWrap: true,
  ...
  Widget getButtons() {
    return nextList ? Container(
          ...
          Container(
            ...
            child: Padding(
              ...
              child: RaisedButton(
                ...
                textColor: Colors.white,
                child: AutoSizeText(
                    "${Globals.weightTitles[Globals.weight.index]} + \$${Globals
      ...
      child: RaisedButton(
        ...
        textColor: Colors.white,
        child: Text(
            "${Globals.carNames[Globals.carSize.index]} + \$${Globals
                .carPrices[Globals.carSize.index]}",
