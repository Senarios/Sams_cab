...
class AppStyle {
  ...
  static Widget requestCard(BuildContext context, dynamic info,
      {Function onMessage, Function onComplete}) {
    return Container(
      child: Wrap(
        children: [
          Card(
            ...
            child: Column(children: [
              ...
              AppStyle.borderButton(context, "Message", 30, 30, 10, 10,
                  onPressed: onMessage),
              info["status"] == "paymentPending"
                  ? AppStyle.borderButton(
                      context, "Complete Ride", 30, 30, 10, 10, onPressed: onComplete)
                  : Container(),
            ]),
          )
        ],
...
class AvailableImages {
  ...
  static const baseLogo = const AssetImage('assets/images/base_screen.png');
